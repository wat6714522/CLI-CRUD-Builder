...
export default class NestJS {
  constructor(options) {
    ...
    this.outputPath =
      options.directory && typeof options.directory === 'string' && options.directory.trim() !== ''
  ...
  async GenerateEntity() {
    ...
    const template = await ReadTemplate(path.join(projectRoot, 'template/NestJS/entity.txt'));
  ...
  async GenerateService() {
    ...
    const template = await ReadTemplate(path.join(projectRoot, 'template/NestJS/service.txt'));
  ...
  async GenerateModule() {
    ...
    const template = await ReadTemplate(path.join(projectRoot, 'template/NestJS/module.txt'));
    const content = this.replaceTemplate(template);
  ...
  async GenerateController() {
    ...
    const template = await ReadTemplate(path.join(projectRoot, 'template/NestJS/controller.txt'));
    const content = this.replaceTemplate(template);
  ...
  async GenerateDBConnect() {
    ...
    const content = await ReadTemplate(path.join(projectRoot, 'template/NestJS/db-connect.txt'));
